...
data Repository = svn(Connection conn, str mod, loc workspace, 
...
data ChangeSet 	= changeset(Revision revision, 
	rel[Resource resource, RevisionChange change] resources, 
	Info committer);
